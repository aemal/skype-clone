...
module.exports ={
	...
	fileFilter :(req, file, cb)=>{
	    ...
	    if (!mimetype && !extname) {
	    	...
	    	return cb(null, false, new Error("File upload only supports the images")); //Error handling needs to be solved and test again, don't worry formidable comes next and it has the same issu here
	    }
